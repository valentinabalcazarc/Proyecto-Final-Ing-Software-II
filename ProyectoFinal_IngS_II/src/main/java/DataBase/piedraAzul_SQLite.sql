...
CREATE TABLE IF NOT EXISTS PROFESSIONAL(
    ...
    CHECK (SPECIALDOC IN ('Neural_therapy', 'Chiropractor', 'Physiotherapy'))
);
...
CREATE TABLE IF NOT EXISTS APPOINTMENT (
    ...
    DATEAPP DATETIME NOT NULL,
    DESCAPP TEXT,
    STATUSAPP TEXT NOT NULL,
    FOREIGN KEY (CODDOC) REFERENCES PROFESSIONAL(CODDOC),
