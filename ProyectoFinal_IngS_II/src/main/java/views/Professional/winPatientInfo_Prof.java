...
import views.Patient.winSelectService_Pat;


public class winPatientInfo_Prof extends javax.swing.JFrame {

    
    public winPatientInfo_Prof() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txt_DateAndTimeAppointment.setBackground(new java.awt.Color(204, 204, 204));
    ...
    private void btnContinueActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContinueActionPerformed
        winSelectService_Pat service = new winSelectService_Pat();
