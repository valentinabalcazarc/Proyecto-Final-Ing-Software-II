...
class AppointmentServiceImplTest {
    ...
    @Mock private UnavailableDayRefRepository unavailableDayRefRepository;
    ...
    @BeforeEach
    void setUp() {
        profMock = new ProfessionalRef();
        profMock.setCodProf(1L);
        profMock.setNameProf("Ana");
        profMock.setLastNameProf("Gómez");
        profMock.setSpecialityProf(SpecialityProfEnum.Physiotherapy);
        profMock.setTypeProf(TypeProfEnum.Doctor);
        profMock.setArrivalTime(LocalTime.of(8, 0));
        profMock.setDepartureTime(LocalTime.of(10, 0));
        profMock.setAttentionInterval(60);

        patientMock = new PatientRef();
        patientMock.setCodPatient(10L);
        patientMock.setNamePatient("Carlos");
        patientMock.setLastNamePatient("Ruiz");

        appointmentMock = new Appointment();
        appointmentMock.setCodApp(100L);
        appointmentMock.setProfessionalRef(profMock);
        appointmentMock.setPatientRef(patientMock);
        appointmentMock.setDateApp(LocalDate.of(2026, 6, 15));
        appointmentMock.setTimeApp(LocalTime.of(9, 0));
        appointmentMock.setStatusApp(StatusAppointment.Scheduled);
    }
    ...
    void generateAvailableSlots_diaNoLaborable() {
        ...
        UnavailableDayRef unavDay = new UnavailableDayRef();
        unavDay.setId(1L);
        unavDay.setProfessionalRef(profMock);
        unavDay.setDate(unavailableDate);
    ...
    void generateAvailableSlots_slotOcupado() {
        ...
        occupied.setProfessionalRef(profMock);
        occupied.setTimeApp(LocalTime.of(8, 0));
        occupied.setDateApp(futureDate);
        occupied.setStatusApp(StatusAppointment.Scheduled);
    ...
    void generateBySpeciality_retornaSlots() {
        ...
        profMock.setArrivalTime(LocalTime.of(0, 0));
        profMock.setDepartureTime(LocalTime.of(0, 30));
        profMock.setAttentionInterval(30);

        when(professionalRefRepository.findBySpecialityProf(SpecialityProfEnum.Physiotherapy))
                .thenReturn(List.of(profMock));
