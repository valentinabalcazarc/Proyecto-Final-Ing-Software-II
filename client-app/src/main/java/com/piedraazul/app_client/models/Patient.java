...
public class Patient {
    ...
    public Patient(int codPatient, Long idPatient, String namePatient, String secondNamePatient, String lastNamePatient, String secondLastNamePatient, int phonePatient, java.time.LocalDate dateBirthPatient, String genderPatient) {
