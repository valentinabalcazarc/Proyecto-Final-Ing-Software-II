...
public class Professional extends User {
    ...
    public Professional(double codProf, String genProf, double phoneProf, StatusUserEnum statusProf, TypeProfEnum typeProf, SpecialityProfEnum SpecialityProf, short attentionInterval, Long codUser, Long cedUser, String passUser, String nameUser, String secondNameUser, String lastNameUser, String secondLastNameUser, StatusUserEnum statusUser, RoleUserEnum roleUser, String securityQuestion, String securityAnswer) {
    ...
    public Professional(Long codUser, Long cedUser, String passUser, String nameUser, String secondNameUser, String lastNameUser, String secondLastNameUser, StatusUserEnum statusUser, RoleUserEnum roleUser, String securityQuestion, String securityAnswer) {
        super(codUser, cedUser, passUser, nameUser, secondNameUser, lastNameUser, secondLastNameUser, statusUser, roleUser, securityQuestion, securityAnswer);
    }
