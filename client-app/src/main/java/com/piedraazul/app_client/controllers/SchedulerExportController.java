...
public class SchedulerExportController {
    ...
    private void handleExport(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/SchedulerExportSelection.fxml"));
            Parent root = loader.load();

            SchedulerExportSelectionController controller = loader.getController();
