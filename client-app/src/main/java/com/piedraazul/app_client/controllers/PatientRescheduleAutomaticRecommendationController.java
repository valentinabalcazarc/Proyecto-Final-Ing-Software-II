...
public class PatientRescheduleAutomaticRecommendationController {
    ...
    private void handleOtrosHorarios(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(
                    getClass().getResource("/fxml/PatientRescheduleSelectSpecificAppointmentView.fxml"));
            Parent root = loader.load();

            PatientRescheduleSelectSpecificAppointmentController controller = loader.getController();
    ...
    private void handleRegresar(ActionEvent event) {
        NavigationService.getInstance().navigateTo("/fxml/PatientViewAppointments.fxml", "Gestionar Citas",
                (Button) event.getSource());
    }
