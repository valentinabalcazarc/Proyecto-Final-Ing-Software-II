...
public class SchedulerCreateAppStep1Controller {
    ...
    private void handleContinue(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/SchedulerCreateAppStep2.fxml"));
            Parent root = loader.load();

            SchedulerCreateAppStep2Controller controller = loader.getController();
