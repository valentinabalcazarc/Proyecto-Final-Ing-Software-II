...
public class SchedulerSelectSpecificAppointmentController {
    ...
    private void handleConfirmar(ActionEvent event) {
        ...
        if (appointment == null) {
            showAlert(Alert.AlertType.WARNING, "Atención", "Por favor, seleccione una fila de la tabla.");
            return;
        }
    ...
    private void handleRegresar(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/SchedulerAutomaticRecommendationView.fxml"));
            ...
            e.printStackTrace();
            showAlert(Alert.AlertType.ERROR, "Error", "No se pudo volver a la vista anterior.");
        }
    }
